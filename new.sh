...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" Foysal Ahmed  [FR13ND8]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Foysal Ahmed"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.P3RC1L] [MR.S∆MAx] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [AldykaPrygh]"$i" |"
echo $i" |"$pu" Contact WhatsApp :"$ku" +8801856035477$i"             |"
echo $i" |"$pu" Contact Gmail :"$ku" FoysalLovePriya@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $cy"Thank you for using my tools"
sleep 2
echo $i"If you are wrong you can ask me"
sleep 2
echo $ku"WhatsApp :"$i" +8801856035477"
echo $ku"Facebook :"$i" Foysal.mjhf"
sleep 2
echo $pur">> Thanks for supporting me <<"
exit
fi